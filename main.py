...
#appended to Policies.dat
    ...
    print("="*50)
    print("{:<2} {:<30} {:<2} {:<2} {:<2}".format(PolicyNum, CustFirstName, InsPrem, FinalTotalCost, TotalPrem))
#Report 1 Above^^ Report 2 Below vv
    ...
    print("{:<2} {:<30} {:<2} {:<2} {:<2}".format(PolicyNum, CustFirstName, TotalPrem, HST, FinalTotalCost, MonthlyPayment))
    print("="*50)
